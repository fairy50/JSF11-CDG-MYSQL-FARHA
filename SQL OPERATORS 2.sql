...
CREATE TABLE EMPLOYEE1(ID INT, EMPNAME VARCHAR(100),SALARY INT);

INSERT INTO EMPLOYEE1 VALUES(1,"FARHA",10000),(2,"FARHA1",20000),(3, "FARHA2",15000),(4,"FARHA3",50000);
...
INSERT INTO EMPLOYEE1 VALUES(5,"FARHA5",20000);

SELECT * FROM EMPLOYEE1;

-- LOGICAL OPR

SELECT * FROM EMPLOYEE1 WHERE SALARY = 10000 AND EMPNAME = "FARHA";
SELECT * FROM EMPLOYEE1 WHERE SALARY = 10000 OR EMPNAME = "FARHA";
...
ALTER TABLE EMPLOYEE1 ADD BONUS VARCHAR(10);
...
SELECT *,
    ...
    SELECT *,
    CASE 
        WHEN SALARY <= 20000 THEN "3X"
        WHEN SALARY <= 50000 THEN "2X"
        ELSE "0X"
	END AS BONUS
    FROM EMPLOYEE1;
    
    CREATE TABLE STUDENT1(FNNAME VARCHAR(50), LNAME VARCHAR(50), AGE INT);
    
    INSERT INTO STUDENT1 VALUES("SAI","T",28),("SAI","V",20),("SAI","V",26);
    
    SELECT CONCAT (FNNAME," ",LNAME ) AS FULL_NAME FROM STUDENT1;
